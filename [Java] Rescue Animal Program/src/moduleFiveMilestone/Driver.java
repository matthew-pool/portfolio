...
public class Driver {
    ...
    public static void intakeNewDog(Scanner scanner) {
        ...
        public static void printAnimals(char option) {
        	...
        	String headerString = "Name\tTraining Status\tIn Service Location\tReserved";
            ...
            case '4': //dog
            	...
            	for (int i = 0; i < dogList.size(); ++i) {
            			...
            			//dog data to print
            			String dataString = "\n" + dogList.get(i).getName() + "\t" + dogList.get(i).getTrainingStatus() + "\t" + 
            								dogList.get(i).getInServiceLocation() + "\t" + dogList.get(i).getReserved();
            ...
            case '5': //monkey
            	...
            	for (int i = 0; i < monkeyList.size(); ++i) {
            			...
            			//monkey data to print
            			String dataString = "\n" + monkeyList.get(i).getName() + "\t" + monkeyList.get(i).getTrainingStatus() + "\t" + 
            								monkeyList.get(i).getInServiceLocation() + "\t" + monkeyList.get(i).getReserved();
            			System.out.println(dataString);
                }
