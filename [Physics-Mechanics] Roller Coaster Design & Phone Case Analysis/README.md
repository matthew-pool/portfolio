...
Comparison of the Newtonian physics involved in a dropped phone with varying case states (no case, silicone case, plastic case, rubber case). Project includes mechanical and mathematical analysis. A custom spreadsheet was used to calculate and display different mathematical properties and values.
